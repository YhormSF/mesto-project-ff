...
// Функция добавления новой карточки + вызов закрытия окна при пройденной валидации
  const handleFormSubmitNewCard = (evt, popup) => {
  evt.preventDefault();
...
// Общее закрытие для всех попапов, которые есть и будут
...
handleFormSubmitNewCard(evt, popupNewCard));
